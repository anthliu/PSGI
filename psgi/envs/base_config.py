...
PAGES = [
    'Walmart GoPage1',  'Walmart GoPage2',  'Walmart GoPage3',
    'Dicks GoPage1',    'Dicks GoPage2',    'Dicks GoPage3',
    'Converse GoPage1', 'Converse GoPage2', 'Converse GoPage3',
    'BestBuy GoPage1',  'BestBuy GoPage2',  'BestBuy GoPage3',
    'Apple GoPage1',    'Apple GoPage2',    'Apple GoPage3',
    'Amazon GoPage1',   'Amazon GoPage2',  # single paged
    'Ebay GoPage1',     'Ebay GoPage2',    # single paged
    'Samsung GoPage1',  'Samsung GoPage2',  'Samsung GoPage3',
    'IKEA GoPage1',     'IKEA GoPage2',     'IKEA GoPage3',    'IKEA GoPage4',
    'Target GoPage1',   'Target GoPage2',   'Target GoPage3',
  'Dummy GoPage1',  'Dummy GoPage2',  'Dummy GoPage3',  # TODO: Remove
]
FINISH = [
    'FinishShipping', 'FinishBilling', 'FinishContact',
    'FinishPayment', 'FinishShipMethod'
]
...
BUTTONS += EXTRAS + EDITS + FAILURE + PAGES + FINISH
