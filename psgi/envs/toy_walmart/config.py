'''Configuration script for ToyWalmart environment.'''
...
##### Stage 0
SUBTASK_LIST = ['Click Walmart GoPage1', 'Fill First']
...
class ToyWalmart(WobConfig):
  ...
  def _construct_task(self, seed: int, keep_pristine: bool = False):
    ...
    """
    g = SubtaskLogicGraph('ToyWalmart')

    ##### Stage 0. Distractors
    g.add_base(['Click Walmart GoPage1'])
    g['Fill First'] = g['Click Walmart GoPage1']
