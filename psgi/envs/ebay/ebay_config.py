...
SUBTASK_LIST = BASE_SUBTASKS + BASE2_SUBTASKS + SHIPPING_SUBTASKS + SELECT_SHIPMETHOD_SUBTASKS + \
    ...
    FINISH1_SUBTASKS + ['Click Ebay GoPage2'] + FINAL_SUBTASKS
...
class Ebay(WobConfig):
  ...
  def _construct_task(self, seed: int, keep_pristine: bool = False):
    ...
    if not keep_pristine:
      ...
      base_subtasks = distractors + base_failures + ['Click Ebay GoPage1']
    ...
    g.add_many_to_one(sources=FINISH1_SUBTASKS, sink='Click Ebay GoPage2')
